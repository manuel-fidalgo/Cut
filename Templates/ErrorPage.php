...
<div id="page">
	...
	<!-- <div class="page-inner"> -->
		<nav class="gtco-nav" role="navigation">
			...
			<!-- FIRST CONTAINER (CONTAINER WHERE THE BACKGROUND IS)
									HEADER 
								-->
											...
											<div class="col-md-12 col-md-offset-0 text-left">
												...
												<div class="row row-mt-15em">
													<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
														<span class="intro-text-small">Oooopss! <a href="<?php $config->printPath(''); ?>" target="_blank">Error</a></span>
														<h1 class="cursive-font">Ha intando acceder a una pagina para la que no tiene permisos, no existe o ha sido cambiada de ubicación.</h1>	
													</div>
												</div>
											</div>
										</div>
